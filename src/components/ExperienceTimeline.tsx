  ...
  return (
    <section id="experience" className="py-20">
      ...
      <VerticalTimeline animate={true} lineColor="rgb(164, 208, 244)">
        ...
        >
          <h3 className="vertical-timeline-element-title">Incoming Software Engineer Intern</h3>
          <h4 className="vertical-timeline-element-subtitle">Pinterest</h4>
          <p className="text-white font-bold">Backend - Infrastructure Organization</p>
        </VerticalTimelineElement>
