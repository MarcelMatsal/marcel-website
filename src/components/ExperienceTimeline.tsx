...
export default function TimelineSection() {
  return (
    <section id="experience" className="py-20">
      ...
      <VerticalTimeline animate={true} lineColor="#6B9FD4">
        ...
        >
          ...
          <p className="text-white font-bold">Developed GenAI tools (such as agents, MCP servers, anomaly detection) for all engineers at Pinterest.</p>
        </VerticalTimelineElement>
        ...
        >
          <h3 className="vertical-timeline-element-title">Senior studying Computer Science and Economics</h3>
